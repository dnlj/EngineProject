...
void run(int argc, char* argv[]) {
	...
	if constexpr (ENGINE_CLIENT) {
		...
		bm.addBind(Layer::GUI, true, InputSequence{
		...
		bm.addBind(Layer::GUI, false, InputSequence{
		...
		//bm.setLayerEnabled(Layer::GUI, false);
	}
