...
#define ENGINE_ASSERT _ENGINE_CREATE_ASSERT_LAMBDA("[ERROR]", true, Engine::ASCII_ERROR, ENGINE_DIE)
#define ENGINE_ASSERT_WARN _ENGINE_CREATE_ASSERT_LAMBDA("[WARN]", true, Engine::ASCII_WARN, 0)
